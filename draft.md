...
discuss the code generator, describe how to extend `mipsdis`, tell you how to
get the code and run it, and then conclude by describing some of the extra
...
The second part to be demonstrated is the command line version of `mipsdis`.
Note that we use the C version of `mipsdis` for this.
